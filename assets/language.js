(function () {
    ...
    const pageTranslations = {
        ...
        'Solde:': { en: 'Balance:', es: 'Saldo:', zh: '余额：', ur: 'بیلنس:' },
        'Tentez votre chance gratuitement !': { en: 'Try your luck for free!', es: '¡Prueba tu suerte gratis!', zh: '免费试试您的运气！', ur: 'مفت اپنی قسمت آزمائیں!' },
        'Félicitations !': { en: 'Congratulations!', es: '¡Felicidades!', zh: '恭喜！', ur: 'مبارک ہو!' },
        'Pas de chance...': { en: 'No luck...', es: 'Sin suerte...', zh: '这次没有中奖……', ur: 'قسمت ساتھ نہیں تھی...' },
        'Une erreur est survenue.': { en: 'An error occurred.', es: 'Ocurrió un error.', zh: '发生错误。', ur: 'ایک خرابی پیش آگئی۔' },
        'Vous avez gagné': { en: 'You won', es: 'Has ganado', zh: '您赢得了', ur: 'آپ نے جیتا' },
        'Le montant a été ajouté à votre solde.': { en: 'The amount has been added to your balance.', es: 'El monto se ha añadido a tu saldo.', zh: '金额已添加到您的余额。', ur: 'رقم آپ کے بیلنس میں شامل کردی گئی ہے۔' },
        'Aucun gain cette fois. Revenez dans 48 heures pour tenter à nouveau votre chance !': { en: 'No winnings this time. Come back in 48 hours to try your luck again!', es: 'No has ganado esta vez. ¡Vuelve en 48 horas para probar suerte de nuevo!', zh: '这次没有中奖。48 小时后再来试试您的运气！', ur: 'اس بار کوئی انعام نہیں ملا۔ دوبارہ قسمت آزمانے کے لیے 48 گھنٹے بعد واپس آئیں!' },
        ...
        'également connu sous le nom de': { en: 'also known as', es: 'también conocido como', zh: '也称为', ur: 'جسے یہ بھی کہا جاتا ہے' },
        "est l'un des plus grands groupes industriels d'Afrique. Il a été fondé par": { en: 'is one of Africa’s largest industrial groups. It was founded by', es: 'es uno de los mayores grupos industriales de África. Fue fundado por', zh: '是非洲最大的工业集团之一，由', ur: 'افریقہ کے سب سے بڑے صنعتی گروپوں میں سے ایک ہے۔ اسے قائم کیا تھا' },
        'et son siège opérationnel se trouve à Lagos, au Nigeria.': { en: 'and its operational headquarters are in Lagos, Nigeria.', es: 'y su sede operativa se encuentra en Lagos, Nigeria.', zh: '其运营总部位于尼日利亚拉各斯。', ur: 'اور اس کا عملی صدر دفتر لاگوس، نائجیریا میں ہے۔' },
        'Le groupe est un conglomérat industriel diversifié présent dans': { en: 'The group is a diversified industrial conglomerate present in', es: 'El grupo es un conglomerado industrial diversificado presente en', zh: '该集团是一个多元化工业联合企业，业务遍及', ur: 'یہ گروپ ایک متنوع صنعتی ادارہ ہے جو موجود ہے' },
        'Sa direction est assurée par Aliko Dangote, Founder & President/CEO.': { en: 'It is led by Aliko Dangote, Founder & President/CEO.', es: 'Está dirigido por Aliko Dangote, fundador y presidente/CEO.', zh: '集团由创始人兼总裁/首席执行官 Aliko Dangote 领导。', ur: 'اس کی قیادت بانی اور صدر/CEO Aliko Dangote کرتے ہیں۔' },
        'pays africains': { en: 'African countries', es: 'países africanos', zh: '个非洲国家', ur: 'افریقی ممالک' },
        'milliards': { en: 'billion', es: 'mil millones', zh: '十亿', ur: 'ارب' },
        'jours': { en: 'days', es: 'días', zh: '天', ur: 'دن' },
        'jour': { en: 'day', es: 'día', zh: '天', ur: 'دن' },
        'Siège opérationnel': { en: 'Operational headquarters', es: 'Sede operativa', zh: '运营总部', ur: 'عملی صدر دفتر' },
        "Pays d'origine": { en: 'Country of origin', es: 'País de origen', zh: '来源国', ur: 'آبائی ملک' },
        'Présence': { en: 'Presence', es: 'Presencia', zh: '业务覆盖', ur: 'موجودگی' },
        'Nature': { en: 'Nature', es: 'Naturaleza', zh: '性质', ur: 'نوعیت' },
        'Conglomérat industriel diversifié': { en: 'Diversified industrial conglomerate', es: 'Conglomerado industrial diversificado', zh: '多元化工业联合企业', ur: 'متنوع صنعتی ادارہ' },
        'Sociétés cotées :': { en: 'Listed companies:', es: 'Empresas cotizadas:', zh: '上市公司：', ur: 'لسٹڈ کمپنیاں:' },
        'Les activités du groupe couvrent notamment :': { en: 'The group’s activities notably include:', es: 'Las actividades del grupo incluyen principalmente:', zh: '集团业务主要包括：', ur: 'گروپ کی سرگرمیوں میں شامل ہیں:' },
        'Ciment': { en: 'Cement', es: 'Cemento', zh: '水泥', ur: 'سیمنٹ' },
        'Raffinage': { en: 'Refining', es: 'Refinación', zh: '炼油', ur: 'ریفائننگ' },
        'Pétrochimie': { en: 'Petrochemicals', es: 'Petroquímica', zh: '石化', ur: 'پیٹروکیمیکل' },
        'Engrais & agriculture': { en: 'Fertilizer & agriculture', es: 'Fertilizantes y agricultura', zh: '化肥与农业', ur: 'کھاد اور زراعت' },
        'Sucre': { en: 'Sugar', es: 'Azúcar', zh: '糖业', ur: 'چینی' },
        'Sel & produits alimentaires': { en: 'Salt & food products', es: 'Sal y productos alimentarios', zh: '盐与食品', ur: 'نمک اور غذائی مصنوعات' },
        'Emballage': { en: 'Packaging', es: 'Embalaje', zh: '包装', ur: 'پیکیجنگ' },
        'Logistique & transport': { en: 'Logistics & transport', es: 'Logistics y transporte', zh: '物流与运输', ur: 'لاجسٹکس اور نقل و حمل' },
        'Ports & maritime': { en: 'Ports & maritime', es: 'Puertos y actividad marítima', zh: '港口与海运', ur: 'بندرگاہیں اور بحری امور' },
        'Mines': { en: 'Mining', es: 'Minería', zh: '采矿', ur: 'کان کنی' },
        'Immobilier & infrastructure': { en: 'Real estate & infrastructure', es: 'Inmobiliaria e infraestructura', zh: '房地产与基础设施', ur: 'رئیل اسٹیٹ اور بنیادی ڈھانچہ' },
        'Automobile': { en: 'Automotive', es: 'Automoción', zh: '汽车', ur: 'آٹوموٹو' },
        'Quelques capacités annoncées :': { en: 'Some announced capacities:', es: 'Algunas capacidades anunciadas:', zh: '部分已公布的产能：', ur: 'اعلان کردہ چند صلاحیتیں:' },
        "Dangote Cement dispose d'une capacité de production annoncée de 55 millions de tonnes par an dans 10 pays africains. La Dangote Petroleum Refinery de Lagos a une capacité actuelle de distillation annoncée de 700 000 barils de pétrole brut par jour.": { en: 'Dangote Cement has an announced production capacity of 55 million tonnes per year in 10 African countries. The Dangote Petroleum Refinery in Lagos has an announced current distillation capacity of 700 000 barrels of crude oil per day.', es: 'Dangote Cement tiene una capacidad de producción anunciada de 55 millones de toneladas al año en 10 países africanos. La Dangote Petroleum Refinery de Lagos tiene una capacidad actual anunciada de destilación de 700 000 barriles de crudo al día.', zh: 'Dangote Cement 在 10 个非洲国家的公布年产能为 55 百万吨。拉各斯 Dangote 石油炼厂公布的当前原油日蒸馏能力为 700 000 桶。', ur: 'Dangote Cement کی اعلان کردہ پیداواری صلاحیت 10 افریقی ممالک میں سالانہ 55 ملین ٹن ہے۔ لاگوس کی Dangote Petroleum Refinery کی اعلان کردہ موجودہ کشید کی صلاحیت روزانہ 700 000 بیرل خام تیل ہے۔' },
        "Dangote Group est constitué de plusieurs sociétés et participations. Il ne faut donc pas lui attribuer un montant unique de « capital social » comme s'il s'agissait d'une seule société cotée.": { en: 'Dangote Group consists of several companies and holdings. It should therefore not be assigned a single “share capital” amount as though it were one listed company.', es: 'Dangote Group está formado por varias empresas y participaciones. Por tanto, no debe atribuirse un único importe de “capital social” como si fuera una sola empresa cotizada.', zh: 'Dangote 集团由多家公司和持股组成，因此不能像对待单一上市公司那样为其指定一个统一的“注册资本”金额。', ur: 'Dangote Group کئی کمپنیوں اور حصص پر مشتمل ہے، اس لیے اسے کسی ایک لسٹڈ کمپنی کی طرح ایک ہی “شیئر کیپیٹل” رقم نہیں دی جانی چاہیے۔' },
        "À titre d'exemple,": { en: 'For example,', es: 'Por ejemplo,', zh: '例如，', ur: 'مثال کے طور پر،' },
        ', cotée à la Nigerian Exchange (NGX), avait au 31 décembre 2025 un capital social émis et entièrement libéré de': { en: ', listed on the Nigerian Exchange (NGX), had issued and fully paid-up share capital of', es: ', cotizada en la Nigerian Exchange (NGX), tenía al 31 de diciembre de 2025 un capital social emitido y totalmente desembolsado de', zh: '，在尼日利亚交易所（NGX）上市，截至 2025 年 12 月 31 日，其已发行并全额缴足的股本为', ur: '، جو Nigerian Exchange (NGX) پر لسٹڈ ہے، 31 دسمبر 2025 کو اس کا جاری کردہ اور مکمل ادا شدہ شیئر کیپیٹل تھا' },
        ', correspondant à 16 873 559 251 actions ordinaires de ₦0,50.': { en: ', corresponding to 16 873 559 251 ordinary shares of ₦0,50.', es: ', correspondiente a 16 873 559 251 acciones ordinarias de ₦0,50.', zh: '，对应 16 873 559 251 股面值 ₦0,50 的普通股。', ur: '، جو ₦0,50 کی 16 873 559 251 عام شیئرز کے برابر ہے۔' },
        'Au 30 juin 2025,': { en: 'As of June 30, 2025,', es: 'Al 30 de junio de 2025,', zh: '截至 2025 年 6 月 30 日，', ur: '30 جون 2025 تک،' },
        'Dangote Industries Limited détenait 87,28 % de Dangote Cement': { en: 'Dangote Industries Limited held 87,28 % of Dangote Cement', es: 'Dangote Industries Limited poseía el 87,28 % de Dangote Cement', zh: 'Dangote Industries Limited 持有 Dangote Cement 的 87,28 % 股份', ur: 'Dangote Industries Limited کے پاس Dangote Cement کے 87,28 % حصص تھے' },
        '. Les trois sociétés cotées du groupe sont Dangote Cement, Dangote Sugar Refinery et NASCON Allied Industries.': { en: '. The group’s three listed companies are Dangote Cement, Dangote Sugar Refinery and NASCON Allied Industries.', es: '. Las tres empresas cotizadas del grupo son Dangote Cement, Dangote Sugar Refinery y NASCON Allied Industries.', zh: '。集团的三家上市公司是 Dangote Cement、Dangote Sugar Refinery 和 NASCON Allied Industries。', ur: '۔ گروپ کی تین لسٹڈ کمپنیاں Dangote Cement، Dangote Sugar Refinery اور NASCON Allied Industries ہیں۔' },
        'Les trois sociétés cotées du groupe sont Dangote Cement, Dangote Sugar Refinery et NASCON Allied Industries.': { en: 'The group’s three listed companies are Dangote Cement, Dangote Sugar Refinery and NASCON Allied Industries.', es: 'Las tres empresas cotizadas del grupo son Dangote Cement, Dangote Sugar Refinery y NASCON Allied Industries.', zh: '集团的三家上市公司是 Dangote Cement、Dangote Sugar Refinery 和 NASCON Allied Industries。', ur: 'گروپ کی تین لسٹڈ کمپنیاں Dangote Cement، Dangote Sugar Refinery اور NASCON Allied Industries ہیں۔' },
        'et NASCON Allied Industries.': { en: 'and NASCON Allied Industries.', es: 'y NASCON Allied Industries.', zh: '和 NASCON Allied Industries。', ur: 'اور NASCON Allied Industries۔' },
        'Le groupe fonctionne comme un ensemble industriel intégré :': { en: 'The group operates as an integrated industrial system:', es: 'El grupo funciona como un conjunto industrial integrado:', zh: '集团作为一个一体化工业体系运营：', ur: 'گروپ ایک مربوط صنعتی نظام کے طور پر کام کرتا ہے:' },
        'Matières premières → production → transformation → énergie → transport et logistique → distribution.': { en: 'Raw materials → production → processing → energy → transport and logistics → distribution.', es: 'Materias primas → producción → transformación → energía → transporte y logística → distribución.', zh: '原材料 → 生产 → 加工 → 能源 → 运输与物流 → 分销。', ur: 'خام مال → پیداوار → پروسیسنگ → توانائی → نقل و حمل اور لاجسٹکس → تقسیم۔' },
        'Cette intégration permet au groupe de relier certaines matières premières, la production industrielle, l’énergie, le transport et la distribution au sein de sa chaîne de valeur.': { en: 'This integration enables the group to connect selected raw materials, industrial production, energy, transport and distribution within its value chain.', es: 'Esta integración permite al grupo conectar determinadas materias primas, la producción industrial, la energía, el transporte y la distribución dentro de su cadena de valor.', zh: '这种一体化使集团能够在价值链中连接原材料、工业生产、能源、运输和分销。', ur: 'یہ انضمام گروپ کو اپنی ویلیو چین میں خام مال، صنعتی پیداوار، توانائی، نقل و حمل اور تقسیم کو مربوط کرنے کے قابل بناتا ہے۔' },
        "Cette intégration permet au groupe de relier certaines matières premières, la production industrielle, l'énergie, le transport et la distribution au sein de sa chaîne de valeur.": { en: 'This integration enables the group to connect selected raw materials, industrial production, energy, transport and distribution within its value chain.', es: 'Esta integración permite al grupo conectar determinadas materias primas, la producción industrial, la energía, el transporte y la distribución dentro de su cadena de valor.', zh: '这种一体化使集团能够在价值链中连接原材料、工业生产、能源、运输和分销。', ur: 'یہ انضمام گروپ کو اپنی ویلیو چین میں خام مال، صنعتی پیداوار، توانائی، نقل و حمل اور تقسیم کو مربوط کرنے کے قابل بناتا ہے۔' },
        'Rechargez votre solde.': { en: 'Top up your balance.', es: 'Recarga tu saldo.', zh: '充值您的余额。', ur: 'اپنا بیلنس جمع کریں۔' },
        'Faites un dépôt en FCFA, puis attendez que le montant apparaisse dans votre solde.': { en: 'Make a deposit in FCFA, then wait for the amount to appear in your balance.', es: 'Haz un depósito en FCFA y espera a que el monto aparezca en tu saldo.', zh: '以 FCFA 充值，然后等待金额显示在余额中。', ur: 'FCFA میں رقم جمع کریں، پھر رقم کے بیلنس میں ظاہر ہونے کا انتظار کریں۔' },
        'Choisissez une action.': { en: 'Choose a share.', es: 'Elige una acción.', zh: '选择一股股票。', ur: 'ایک شیئر منتخب کریں۔' },
        "La page Plans affiche les quatre actions disponibles et le prix d'une action.": { en: 'The Plans page shows the four available shares and the price of one share.', es: 'La página de planes muestra las cuatro acciones disponibles y el precio de una acción.', zh: '计划页面显示四种可用股票及每股价格。', ur: 'منصوبوں کا صفحہ چار دستیاب شیئرز اور ایک شیئر کی قیمت دکھاتا ہے۔' },
        "Choisissez le nombre d'actions.": { en: 'Choose the number of shares.', es: 'Elige el número de acciones.', zh: '选择股票数量。', ur: 'شیئرز کی تعداد منتخب کریں۔' },
        'Le minimum est de': { en: 'The minimum is', es: 'El mínimo es de', zh: '最低数量为', ur: 'کم از کم تعداد' },
        'actions par achat': { en: 'shares per purchase', es: 'acciones por compra', zh: '股/次购买', ur: 'ہر خریداری میں شیئرز' },
        'Les fractions sont acceptées, par exemple': { en: 'Fractions are accepted, for example', es: 'Se aceptan fracciones, por ejemplo', zh: '支持购买小数股，例如', ur: 'اعشاری حصے قبول ہیں، مثلاً' },
        'Vérifiez le montant de départ.': { en: 'Check the starting amount.', es: 'Comprueba el monto inicial.', zh: '查看起始金额。', ur: 'ابتدائی رقم چیک کریں۔' },
        'Vous pouvez soit saisir le nombre d’actions, soit saisir directement un montant en FCFA.': { en: 'You can enter either the number of shares or an amount directly in FCFA.', es: 'Puedes introducir el número de acciones o directamente un monto en FCFA.', zh: '您可以输入股票数量，也可以直接输入 FCFA 金额。', ur: 'آپ شیئرز کی تعداد یا براہ راست FCFA میں رقم درج کر سکتے ہیں۔' },
        "Vous pouvez soit saisir le nombre d'actions, soit saisir directement un montant en FCFA.": { en: 'You can enter either the number of shares or an amount directly in FCFA.', es: 'Puedes introducir el número de acciones o directamente un monto en FCFA.', zh: '您可以输入股票数量，也可以直接输入 FCFA 金额。', ur: 'آپ شیئرز کی تعداد یا براہ راست FCFA میں رقم درج کر سکتے ہیں۔' },
        'Vous pouvez soit saisir le nombre d’actions, soit saisir directement un montant en FCFA': { en: 'You can enter either the number of shares or an amount directly in FCFA', es: 'Puedes introducir el número de acciones o directamente un monto en FCFA', zh: '您可以输入股票数量，也可以直接输入 FCFA 金额', ur: 'آپ شیئرز کی تعداد یا براہ راست FCFA میں رقم درج کر سکتے ہیں' },
        "Vous pouvez soit saisir le nombre d'actions, soit saisir directement un montant en FCFA": { en: 'You can enter either the number of shares or an amount directly in FCFA', es: 'Puedes introducir el número de acciones o directamente un monto en FCFA', zh: '您可以输入股票数量，也可以直接输入 FCFA 金额', ur: 'آپ شیئرز کی تعداد یا براہ راست FCFA میں رقم درج کر سکتے ہیں' },
        'Dans ce second cas, le nombre d’actions est calculé automatiquement selon la formule': { en: 'In the second case, the number of shares is calculated automatically using the formula', es: 'En el segundo caso, el número de acciones se calcula automáticamente según la fórmula', zh: '在第二种情况下，股票数量会根据以下公式自动计算', ur: 'دوسری صورت میں شیئرز کی تعداد اس فارمولے کے مطابق خود بخود شمار ہوتی ہے' },
        "Dans ce second cas, le nombre d'actions est calculé automatiquement selon la formule": { en: 'In the second case, the number of shares is calculated automatically using the formula', es: 'En el segundo caso, el número de acciones se calcula automáticamente según la fórmula', zh: '在第二种情况下，股票数量会根据以下公式自动计算', ur: 'دوسری صورت میں شیئرز کی تعداد اس فارمولے کے مطابق خود بخود شمار ہوتی ہے' },
        "montant ÷ prix d'une action": { en: 'amount ÷ price per share', es: 'monto ÷ precio por acción', zh: '金额 ÷ 每股价格', ur: 'رقم ÷ فی شیئر قیمت' },
        'Vérifiez le taux.': { en: 'Check the rate.', es: 'Comprueba la tasa.', zh: '查看利率。', ur: 'شرح چیک کریں۔' },
        'Le taux quotidien dépend du montant total de cet achat, selon le tableau ci-dessous.': { en: 'The daily rate depends on the total amount of this purchase, according to the table below.', es: 'La tasa diaria depende del monto total de esta compra, según la tabla siguiente.', zh: '每日利率根据本次购买的总金额按下表确定。', ur: 'روزانہ شرح اس خریداری کی کل رقم کے مطابق نیچے دیے گئے جدول پر منحصر ہے۔' },
        'Confirmez.': { en: 'Confirm.', es: 'Confirma.', zh: '确认。', ur: 'تصدیق کریں۔' },
        'Le montant est débité du solde et la commande devient active pendant': { en: 'The amount is deducted from your balance and the order becomes active for', es: 'El monto se descuenta de tu saldo y la orden queda activa durante', zh: '金额将从余额中扣除，订单有效期为', ur: 'رقم آپ کے بیلنس سے منہا ہوگی اور آرڈر فعال رہے گا' },
        'Recevez vos gains.': { en: 'Receive your earnings.', es: 'Recibe tus ganancias.', zh: '领取您的收益。', ur: 'اپنی آمدنی حاصل کریں۔' },
        'Le gain quotidien enregistré pour cette commande est crédité automatiquement toutes les 24 heures.': { en: 'The daily earnings recorded for this order are credited automatically every 24 hours.', es: 'Las ganancias diarias registradas para esta orden se acreditan automáticamente cada 24 horas.', zh: '该订单记录的每日收益每24小时自动到账。', ur: 'اس آرڈر کی روزانہ آمدنی ہر 24 گھنٹے میں خود بخود جمع ہوتی ہے۔' },
        "Limite d'achat.": { en: 'Purchase limit.', es: 'Límite de compra.', zh: '购买限制。', ur: 'خریداری کی حد۔' },
        'Un même plan peut être acheté au maximum': { en: 'The same plan can be purchased a maximum of', es: 'El mismo plan puede comprarse como máximo', zh: '同一计划最多可购买', ur: 'ایک ہی منصوبہ زیادہ سے زیادہ' },
        'fois par utilisateur': { en: 'times per user', es: 'veces por usuario', zh: '次/每位用户', ur: 'بار فی صارف' },
        'La limite est comptée sur toutes les commandes de ce plan, pas seulement les commandes encore actives.': { en: 'The limit counts all orders for this plan, not only orders that are still active.', es: 'El límite cuenta todas las órdenes de este plan, no solo las que siguen activas.', zh: '该限制统计此计划的所有订单，而不仅是仍处于活动状态的订单。', ur: 'یہ حد اس منصوبے کے تمام آرڈرز پر لاگو ہوتی ہے، صرف فعال آرڈرز پر نہیں۔' },
        'Le taux est appliqué au': { en: 'The rate is applied to the', es: 'La tasa se aplica al', zh: '利率适用于', ur: 'شرح لاگو ہوتی ہے' },
        "montant total de l'achat": { en: 'total purchase amount', es: 'monto total de la compra', zh: '购买总金额', ur: 'خریداری کی کل رقم' },
        ", et non au nombre d'actions séparément.": { en: ', not to the number of shares separately.', es: ', no al número de acciones por separado.', zh: '，而不是分别适用于股票数量。', ur: '، نہ کہ الگ الگ شیئرز کی تعداد پر۔' },
        'Taux / jour': { en: 'Rate / day', es: 'Tasa / día', zh: '每日利率', ur: 'شرح / دن' },
        'Montant de l’achat': { en: 'Purchase amount', es: 'Monto de la compra', zh: '购买金额', ur: 'خریداری کی رقم' },
        'Exemple :': { en: 'Example:', es: 'Ejemplo:', zh: '示例：', ur: 'مثال:' },
        'un achat de 2 250 FCFA à 5 % produit': { en: 'a purchase of 2 250 FCFA at 5 % produces', es: 'una compra de 2 250 FCFA al 5 % produce', zh: '一笔 2 250 FCFA、利率为 5 % 的购买每天产生', ur: '2 250 FCFA کی 5 % شرح والی خریداری سے حاصل ہوتا ہے' },
        '. Un achat de 100 000 FCFA tombe dans la tranche 15 % et produit': { en: '. A purchase of 100 000 FCFA falls into the 15 % tier and produces', es: '. Una compra de 100 000 FCFA entra en el tramo del 15 % y produce', zh: '。一笔 100 000 FCFA 的购买属于 15 % 档位，每天产生', ur: '۔ 100 000 FCFA کی خریداری 15 % کے درجے میں آتی ہے اور حاصل ہوتا ہے' },
        'Le montant minimum d’investissement est de': { en: 'The minimum investment amount is', es: 'El monto mínimo de inversión es de', zh: '最低投资金额为', ur: 'سرمایہ کاری کی کم از کم رقم ہے' },
        'Le plan maximum est de': { en: 'The maximum plan is', es: 'El plan máximo es de', zh: '最高计划金额为', ur: 'زیادہ سے زیادہ منصوبہ ہے' },
        'Chaque achat commence à 10 actions minimum.': { en: 'Each purchase starts at a minimum of 10 shares.', es: 'Cada compra comienza con un mínimo de 10 acciones.', zh: '每次购买至少从10股开始。', ur: 'ہر خریداری کم از کم 10 شیئرز سے شروع ہوتی ہے۔' },
        'Les prix indiqués sont ceux configurés dans la plateforme. Vérifiez toujours le récapitulatif affiché avant de confirmer un achat.': { en: 'The listed prices are configured on the platform. Always check the displayed summary before confirming a purchase.', es: 'Los precios indicados están configurados en la plataforma. Comprueba siempre el resumen mostrado antes de confirmar una compra.', zh: '所列价格为平台配置价格。确认购买前请务必检查显示的摘要。', ur: 'درج قیمتیں پلیٹ فارم پر ترتیب دی گئی ہیں۔ خریداری کی تصدیق سے پہلے دکھایا گیا خلاصہ ضرور چیک کریں۔' },
        'Aucun plan actif pour le moment.': { en: 'No active plans at the moment.', es: 'No hay planes activos por ahora.', zh: '目前没有有效计划。', ur: 'فی الحال کوئی فعال منصوبہ نہیں۔' },
        'Allez dans': { en: 'Go to', es: 'Ve a', zh: '进入', ur: 'جائیں' },
        'choisissez votre pays et opérateur Mobile Money, entrez le montant': { en: 'choose your country and Mobile Money operator, enter the amount', es: 'elige tu país y operador de Mobile Money, introduce el monto', zh: '选择您的国家和移动支付运营商，输入金额', ur: 'اپنا ملک اور موبائل منی آپریٹر منتخب کریں، رقم درج کریں' },
        'Pays supportés :': { en: 'Supported countries:', es: 'Países admitidos:', zh: '支持的国家：', ur: 'معاون ممالک:' },
        'Les retraits sont disponibles les jours :': { en: 'Withdrawals are available on:', es: 'Los retiros están disponibles los días:', zh: '提现开放日期：', ur: 'رقم نکلوانا ان دنوں دستیاب ہے:' },
        'Maximum 1 retrait(s) par 24 heures': { en: 'Maximum 1 withdrawal per 24 hours', es: 'Máximo 1 retiro por 24 horas', zh: '24小时内最多提现1次', ur: '24 گھنٹوں میں زیادہ سے زیادہ 1 بار رقم نکلوانا' },
        'Vous devez avoir un plan d’investissement actif': { en: 'You must have an active investment plan', es: 'Debes tener un plan de inversión activo', zh: '您必须拥有有效的投资计划', ur: 'آپ کے پاس ایک فعال سرمایہ کاری کا منصوبہ ہونا چاہیے' },
        'Les retraits sont traités dans un délai de': { en: 'Withdrawals are processed within', es: 'Los retiros se procesan en un plazo de', zh: '提现将在', ur: 'رقم نکلوانے پر کارروائی ہوتی ہے' },
        'après validation de votre demande par notre équipe. Le service client est disponible 7j/7 pour toute question.': { en: 'after our team validates your request. Customer service is available 7 days a week for any questions.', es: 'después de que nuestro equipo valide tu solicitud. El servicio de atención está disponible 7 días a la semana.', zh: '在我们的团队验证申请后完成。客服每周7天为您提供咨询。', ur: 'ہماری ٹیم کی جانب سے درخواست کی تصدیق کے بعد۔ کسی بھی سوال کے لیے کسٹمر سروس 7 دن دستیاب ہے۔' },
        ...
        'Retrait minimum :': { en: 'Minimum withdrawal:', es: 'Retiro mínimo:', zh: '最低提现金额：', ur: 'کم از کم رقم نکلوانا:' },
        'Maximum': { en: 'Maximum', es: 'Máximo', zh: '最多', ur: 'زیادہ سے زیادہ' },
        'retrait(s) par 24 heures': { en: 'withdrawal(s) per 24 hours', es: 'retiro(s) por 24 horas', zh: '24小时内提现次数', ur: '24 گھنٹوں میں رقم نکلوانا' },
        'Traitement sous 24h': { en: 'Processed within 24 hours', es: 'Procesamiento en 24 h', zh: '24小时内处理', ur: '24 گھنٹوں میں کارروائی' },
        "Vous devez avoir un plan d'investissement actif": { en: 'You must have an active investment plan', es: 'Debes tener un plan de inversión activo', zh: '您必须拥有有效的投资计划', ur: 'آپ کے پاس ایک فعال سرمایہ کاری کا منصوبہ ہونا چاہیے' },
        ...
        'Partagez votre lien de parrainage unique.': { en: 'Share your unique referral link.', es: 'Comparte tu enlace de referido único.', zh: '分享您的专属推荐链接。', ur: 'اپنا منفرد ریفرل لنک شیئر کریں۔' },
        'Vous gagnez des commissions sur les investissements de vos filleuls sur 3 niveaux :': { en: 'You earn commissions on your referrals’ investments across 3 levels:', es: 'Ganas comisiones por las inversiones de tus referidos en 3 niveles:', zh: '您可以从推荐人的投资中获得 3 个级别的佣金：', ur: 'آپ اپنے ریفرلز کی سرمایہ کاری پر 3 سطحوں تک کمیشن حاصل کرتے ہیں:' },
        'Commission directe (Niveau 1)': { en: 'Direct commission (Level 1)', es: 'Comisión directa (Nivel 1)', zh: '直接佣金（等级 1）', ur: 'براہ راست کمیشن (سطح 1)' },
        'Niveau 2': { en: 'Level 2', es: 'Nivel 2', zh: '等级 2', ur: 'سطح 2' },
        'Niveau 3': { en: 'Level 3', es: 'Nivel 3', zh: '等级 3', ur: 'سطح 3' },
        'Des récompenses complémentaires sont prévues pour les ambassadeurs atteignant les objectifs définis.': { en: 'Additional rewards are available for ambassadors who reach the defined goals.', es: 'Hay recompensas adicionales para los embajadores que alcancen los objetivos definidos.', zh: '达到既定目标的大使还可获得额外奖励。', ur: 'مقررہ اہداف حاصل کرنے والے سفیروں کے لیے اضافی انعامات دستیاب ہیں۔' },
        ...
        'Les retraits sont envoyés directement vers le numéro de téléphone enregistré sur votre compte, sans configuration supplémentaire.': { en: 'Withdrawals are sent directly to the phone number registered on your account, with no additional setup.', es: 'Los retiros se envían directamente al número de teléfono registrado en tu cuenta, sin configuración adicional.', zh: '提现会直接发送到您账户登记的电话号码，无需额外设置。', ur: 'رقم براہ راست آپ کے اکاؤنٹ پر رجسٹرڈ فون نمبر پر بھیجی جاتی ہے، کسی اضافی سیٹ اپ کے بغیر۔' },
        ...
        'Nos activités reposent sur des principes fondamentaux :': { en: 'Our activities are based on fundamental principles:', es: 'Nuestras actividades se basan en principios fundamentales:', zh: '我们的活动建立在以下基本原则之上：', ur: 'ہماری سرگرمیاں بنیادی اصولوں پر مبنی ہیں:' },
        'Transparence': { en: 'Transparency', es: 'Transparencia', zh: '透明度', ur: 'شفافیت' },
        'Innovation': { en: 'Innovation', es: 'Innovación', zh: '创新', ur: 'جدت' },
        'Intégrité': { en: 'Integrity', es: 'Integridad', zh: '诚信', ur: 'دیانت داری' },
        'Excellence': { en: 'Excellence', es: 'Excelencia', zh: '卓越', ur: 'بہتری' },
        'Responsabilité': { en: 'Responsibility', es: 'Responsabilidad', zh: '责任', ur: 'ذمہ داری' },
        'Inclusion financière': { en: 'Financial inclusion', es: 'Inclusión financiera', zh: '金融普惠', ur: 'مالی شمولیت' },
        'Développement durable': { en: 'Sustainable development', es: 'Desarrollo sostenible', zh: '可持续发展', ur: 'پائیدار ترقی' },
        '« Investir dans le potentiel de l’Afrique. Construire ensemble la prospérité de demain. »': { en: '“Invest in Africa’s potential. Build tomorrow’s prosperity together.”', es: '« Invertir en el potencial de África. Construir juntos la prosperidad del mañana. »', zh: '“投资非洲的潜力，共同建设明天的繁荣。”', ur: '“افریقہ کی صلاحیت میں سرمایہ کاری کریں۔ مل کر کل کی خوشحالی تعمیر کریں۔”' },
