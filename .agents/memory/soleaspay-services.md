...
**How to apply:** Accept `data[]`, filter active Mobile Money entries from the service name/description when type is absent, and persist the selected numeric service ID per country/operator.